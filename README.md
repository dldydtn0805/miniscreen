...
### 현재 페이지 위에 미니 브라우저 열기

![MINISCREEN overview](./docs/images/store-screenshots-1280/overview.png)

### 모바일/데스크톱 뷰 전환

![MINISCREEN view modes](./docs/images/store-screenshots-1280/modes.png)

### 북마크 패널로 빠르게 다시 열기

![MINISCREEN bookmarks](./docs/images/store-screenshots-1280/bookmarks.png)
...
- 스피커 버튼: 미니 화면 내부 오디오 음소거/해제
- 현재 음소거 상태는 프레임 이동 시에도 유지되도록 동기화됩니다.
- 일반 `audio`/`video` 요소와 일부 YouTube 플레이어 음소거 처리까지 반영합니다.
